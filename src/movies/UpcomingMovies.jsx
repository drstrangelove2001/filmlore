/* 
This is the React component responsible for content in the upcoming movies page.
*/
...
export default class UpcomingMovies extends Component {
	...
	async fetchData() {
		const query = `query GetFilmsComingSoon {
			getFilmsComingSoon {
			  film_id
				imdb_id
				imdb_title_id
		...
		this.setState({ upcomingMovies: data.getFilmsComingSoon, isLoading: false });
	}
	...
	render() {
		...
		return (
			<div>
				...
				</div>) : (<div> <p className="text-center recoresult-title">movies upcoming</p><div className="container">
